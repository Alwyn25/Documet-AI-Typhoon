...
class StructuredLogger:
    """Structured logger for the ingestion service."""

    def __init__(self):
        self.logger = logging.getLogger("ingestion_agent")
    ...
    def _configure_handlers(self) -> None:
        ...
        info_log_path = log_dir / "ingestion_service.log"
        error_log_path = log_dir / "ingestion_service_error.log"
